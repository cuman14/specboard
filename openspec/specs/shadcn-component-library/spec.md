# Spec: shadcn Component Library

## Purpose
Define the shadcn/ui component library used across Specboard, ensuring consistent UI patterns, accessibility, and dark theme integration.

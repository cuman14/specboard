# Archive Change Action

## Purpose
Defines the archive action capability — controlling when and how a completed change can be archived, including button enablement, confirmation, and error handling.

...
npm package that wraps the native Tauri binary. Detects host OS/architecture during postinstall, downloads the correct artifact from GitHub Releases, and provides a CLI wrapper (`specboard` command).
